          ...
          {employeeProfile && (
            <div style={styles.section}>
              ...
              <div style={{ display: 'flex', gap: '12px', marginBottom: '24px', flexWrap: 'wrap' }}>
                <div style={styles.salaryItem}>
                  <div style={styles.salaryLabel}>Total Advance Paid</div>
                  <div style={{ ...styles.salaryValue, color: '#e74c3c' }}>
                    ₹{employeeProfile.total_advance_paid}
                  </div>
                </div>
                <div style={styles.salaryItem}>
                  <div style={styles.salaryLabel}>Salary Generated</div>
                  <div style={{ ...styles.salaryValue, color: '#3498db' }}>
                    ₹{employeeProfile.total_salary_generated}
                  </div>
                </div>
                <div style={styles.salaryItem}>
                  <div style={styles.salaryLabel}>Total Paid</div>
                  <div style={{ ...styles.salaryValue, color: '#27ae60' }}>
                    ₹{employeeProfile.total_paid}
                  </div>
                </div>
                <div style={{
                  ...styles.salaryItem,
                  backgroundColor: employeeProfile.remaining_due > 0 ? '#fff5f5' : '#f0fff4'
                }}>
                  <div style={styles.salaryLabel}>
                    {employeeProfile.remaining_due > 0 ? 'Salary Due to Employee' : 'Advance Balance'}
                  </div>
                  <div style={{
                    ...styles.salaryValue,
                    color: employeeProfile.remaining_due > 0 ? '#e74c3c' : '#27ae60'
                  }}>
                    ₹{Math.abs(employeeProfile.remaining_due)}
                  </div>
                </div>
              </div>
                  ...
                  <tbody>
                    {employeeProfile.payment_history.map((p, i) => (
                      ...
                      >
                        ...
                        <td style={styles.td}>
                          <strong style={{ color: '#1a1a2e' }}>₹{p.amount}</strong>
                        </td>
                      </tr>
                    ))}
                  </tbody>
